...
SteamPriceManager.prototype.getInventory = function(details, callback) {
	...
	community.getSteamUser(SteamID64, function(err, user) {
		...
		user.getInventory(appID, contextID, tradableOnly, function(err, inventory) {
			...
			if(getWithPrices) {
				inventory = this._addPricesToInventory(inventory, this._addProps);
			}
...
// TODO: Error handling
SteamPriceManager.prototype._addPricesToInventory = function(inventory, callback) {
	...
	return callback(inventory, prices);
}

SteamPriceManager.prototype._addProps = function(inventory,prices){
